...
export const perfectStreak = "PERFECT_STREAK";
...
// API URLS
export const startApi = "api/userGame/start";
export const updateApi = "api/userGame/update";
export const viewApi = "api/userGame/view";
